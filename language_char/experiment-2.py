...
parser.add_argument('--preprocess', action='store_true') # 下载
...
parser.add_argument('--validseqlen', type=int, default=320) # 320
...
model_name = "data_{}_d_{}_h_{}_type_{}_ksize_{}_level_{}_n_{}_lr_{}_dropout_{}_two".format(
